...
$hasil3 = mysqli_query($koneksi, "SELECT * FROM tbl_data_paket INNER JOIN tbl_jenis_paket USING(jenispaket_id) INNER JOIN tbl_agent_travel USING(travel_id) WHERE tbl_data_paket.travel_id='$id'");
