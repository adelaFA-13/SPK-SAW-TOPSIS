...
include 'koneksi.php';
	...
	return $nilaipesawat[($kd_pesawat)];
}
...
include 'koneksi.php';
	...
	return $nilai_fasilitas[($kd_fasil)];
...
function getHarga($kd_harga){
	...
	return number_format($data[($kd_harga)]['harga_paket'],2);
}
