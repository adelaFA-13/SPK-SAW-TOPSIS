<?php include 'halaman/pengguna_header.php'; ?>
<header class="text-center">
          ...
          <div class="section-popular-travel row justify-content-center">
            <div class="col-sm-6 col-md-4 col-lg-3">
              <div
                ...
                style="background-image: url('/Asset3/images/travel-1.jpg');"
              >
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-8 text-center">
              <img src="assets/images/partner.png" class="img-patner" />
            </div>
          </div>
        </div>
      </section>
    ...
    <?php include 'halaman/footer_pengguna.php'; ?>