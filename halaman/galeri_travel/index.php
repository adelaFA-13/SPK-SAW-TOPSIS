                               ...
                               <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><img src="<?php echo "config/galeri/".$row['foto']; ?>" width="100"/></<td>
                                        <td align="center">
                                        <a href="config/galeri/delete.php?id=<?php echo $row['id']?>" class="btn btn-xs btn-danger" title="delete" onclick="retrun confirm('Apakah anda yakin ingin menghapus?')">
