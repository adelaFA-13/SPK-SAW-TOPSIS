    ...
    <div class="containter-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 text-primary">Input Mitra Travel Agent Baru</h6>
            </div>
            <div class="card-body">
                <!--Mulai form  -->
                ...
                <input type="hidden" name="kd_user" value="<?php echo $auto_user?>">
                    ...
                    <div class="col-lg-3">
                            <label for="NamaMitra">Username Mitra</label>
                        </div>
                        <div class="col-lg-1">:</div>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="usernameagent" placeholder="Masukan Username Agent Travel" id="
                            NamaMitra">
                        </div>
                    </div>
                    <div class="row form-group">
                    <div class="col-lg-3">
                        ...
                        <div class="col-lg-1">:</div>
                        <div class="col-lg-8">
                            <input type="email" class="form-control" name="email_agent" placeholder="Masukan Alamat Email">
                        </div>
                    </div>
                    <div class="row form-group">
                    <div class="col-lg-3">
                        ...
                        <div class="col-lg-1">:</div>
                        <div class="col-lg-8">
                            <input type="password" class="form-control" name="password_agent" placeholder="Masukan Password">
                        </div>
                    </div>
