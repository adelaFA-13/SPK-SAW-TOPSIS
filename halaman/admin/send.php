...
$nama_pengirim = 'ADMIN TRAVEL AGENT HAJI & UMRAH'; // Isikan dengan nama pengirim
...
$pesan = "Selamat akun telah terverifikasi silahkan login di untuk melengkapi data anda"; // Ambil pesan dari inputan form
...
$mail->Password = 'lcgvwloyubrwgtmp'; // Isikan dengan Password email pengirim
$mail->Port = 465;
$mail->SMTPAuth = true;
$mail->SMTPSecure = 'ssl';
...
if(empty($attachment)){ // Jika tanpa attachment
    ...
    if($send){ // Jika Email berhasil dikirim
        echo "<h5>Email berhasil dikirim</h5><br /><a href='index.php?url=data_agent_travelperh'>Kembali ke Form</a>";
    }else{ // Jika Email gagal dikirim
        echo "<h5>Email gagal dikirim</h5><br /><a href='index.php?url=data_agent_travel'>Kembali ke Form</a>";
