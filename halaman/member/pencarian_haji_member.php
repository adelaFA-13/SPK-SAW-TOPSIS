          ...
          <div class="row">
                  ...
                  <div class="attendee">
                    <table class="table table-bordered table-hover table-xs text-center">
                      ...
                      <tr style="font-size:12px;">
                        <td><?php echo $i++?></td>
                        <td> <a href="index.php?url=detail_data_paket&id=<?php echo $row['paket_data_id'];?>&Travel=<?php echo $row['travel_id'];?>"><?php echo $row['nama']?></a>
                          </td>
                        <td>
                          <div class="row">
                            <div class="col-sm-12">
              ...
              <div class="col-lg-3">
                <div class="card card-details">
                  ...
                  <form action="config/pencarian/perhitungan_haji_member.php" method="POST">
